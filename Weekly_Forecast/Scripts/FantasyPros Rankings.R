...
FF.FantasyPros.Set.ppr.rest.of.season.rankings = function(week) {
  ...
  save(num, file = paste(getMYFFDir(),"/Weekly Forecast/FantasyPros_Rankings/PPR_Rankings_Week_",week,"_Date_",strftime(Sys.time(), format = "%Y_%m_%d"),".RData", sep=""))
  write.csv(num, file=paste(getMYFFDir(),"/Weekly Forecast/FantasyPros_Rankings/PPR_Rankings_Week_",week,"_Date_",strftime(Sys.time(), format = "%Y_%m_%d"),".csv", sep=""), row.names=FALSE)
  ...
  save(num, file = paste(getMYFFDir(),"/Weekly Forecast/FantasyPros_Rankings/PPR_NW_Rankings_Week_",week,"_Date_",strftime(Sys.time(), format = "%Y_%m_%d"),".RData", sep=""))
  write.csv(num, file=paste(getMYFFDir(),"/Weekly Forecast/FantasyPros_Rankings/PPR_NW_Rankings_Week_",week,"_Date_",strftime(Sys.time(), format = "%Y_%m_%d"),".csv", sep=""), row.names=FALSE)
...
FF.FantasyPros.Set.half.ppr.rest.of.season.rankings = function(week) {
  ...
  save(num, file = paste(getMYFFDir(),"/Weekly Forecast/FantasyPros_Rankings/Half_PPR_Rankings_Week_",week,"_Date_",strftime(Sys.time(), format = "%Y_%m_%d"),".RData", sep=""))
  write.csv(num, file=paste(getMYFFDir(),"/Weekly Forecast/FantasyPros_Rankings/Half_PPR_Rankings_Week_",week,"_Date_",strftime(Sys.time(), format = "%Y_%m_%d"),".csv", sep=""), row.names=FALSE)
  ...
  save(num, file = paste(getMYFFDir(),"/Weekly Forecast/FantasyPros_Rankings/Half_PPR_NW_Rankings_Week_",week,"_Date_",strftime(Sys.time(), format = "%Y_%m_%d"),".RData", sep=""))
  write.csv(num, file=paste(getMYFFDir(),"/Weekly Forecast/FantasyPros_Rankings/Half_PPR_NW_Rankings_Week_",week,"_Date_",strftime(Sys.time(), format = "%Y_%m_%d"),".csv", sep=""), row.names=FALSE)
...
getFantasyPros_PPR_ROS_Rankings = function(week){
  ...
  ros = getProjections(paste(getMYFFDir(),"/Weekly Forecast/FantasyPros_Rankings/PPR_Rankings_Week_",week,"_Date_",sep=""))
  nw = getProjections(paste(getMYFFDir(),"/Weekly Forecast/FantasyPros_Rankings/PPR_NW_Rankings_Week_",week,"_Date_",sep=""))
...
getFantasyPros_Half_PPR_ROS_Rankings = function(week){
  ...
  ros = getProjections(paste(getMYFFDir(),"/Weekly Forecast/FantasyPros_Rankings/Half_PPR_Rankings_Week_",week,"_Date_",sep=""))
  nw = getProjections(paste(getMYFFDir(),"/Weekly Forecast/FantasyPros_Rankings/Half_PPR_NW_Rankings_Week_",week,"_Date_",sep=""))
  colnames(nw)[-c(2,9)] = paste0("NW:",colnames(nw)[-c(2,9)])
  m = merge(x=ros,y=nw,by=c("Player","Player.Name"),all.x=TRUE)
  return(m[order(m$Rank),])
}
getFantasyPros_Kicker_Rankings = function(week){
  ...
  ros = getProjections(paste(getMYFFDir(),"/Weekly Forecast/FantasyPros_Rankings/Kicker_ROS_Rankings_Week_",week,"_Date_",sep=""))
  nw = getProjections(paste(getMYFFDir(),"/Weekly Forecast/FantasyPros_Rankings/Kicker_Rankings_Week_",week,"_Date_",sep=""))
...
getFantasyPros_DST_Rankings = function(week){
  ...
  ros = getProjections(paste(getMYFFDir(),"/Weekly Forecast/FantasyPros_Rankings/DST_ROS_Rankings_Week_",week,"_Date_",sep=""))
  nw = getProjections(paste(getMYFFDir(),"/Weekly Forecast/FantasyPros_Rankings/DST_Rankings_Week_",week,"_Date_",sep=""))
