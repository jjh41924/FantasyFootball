...
getFantasyPros_PPR_ROS_Rankings = function(week){
  ...
  return(getProjections(paste(getMYFFDir(),"/Weekly_Forecast/FantasyPros_Rankings/PPR_Rankings_Week_",week,"_Date_",sep="")))
}
getFantasyPros_Half_PPR_ROS_Rankings = function(week){
  FF.FantasyPros.Set.half.ppr.rest.of.season.rankings(week)
  return(getProjections(paste(getMYFFDir(),"/Weekly_Forecast/FantasyPros_Rankings/Half_PPR_Rankings_Week_",week,"_Date_",sep="")))
}
getFantasyPros_Kicker_Rankings = function(week){
  FF.FantasyPros.Set.Kicker(week)
  return(getProjections(paste(getMYFFDir(),"/Weekly_Forecast/FantasyPros_Rankings/Kicker_Rankings_Week_",week,"_Date_",sep="")))
}
getFantasyPros_DST_Rankings = function(week){
  FF.FantasyPros.Set.DST(week)
  return(getProjections(paste(getMYFFDir(),"/Weekly_Forecast/FantasyPros_Rankings/DST_Rankings_Week_",week,"_Date_",sep="")))
}
